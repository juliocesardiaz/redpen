 ...
 *
 * The tag chip multi-select inside the comment modal, the standalone tag
 * manager modal (rename / recolour / delete), and the helper used by code
 * rendering to pick the primary tag for an annotation. See
...
(function () {
  ...
  R.primaryTagForAnnotation = primaryTagForAnnotation;
