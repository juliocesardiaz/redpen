 ...
 *
 * Folder import builds a queue of submissions; the optional names CSV maps
 * usernames to real names. Also owns queue navigation (prev/next, the queue
 * drawer) and batch "Export all". See redpen-author-core.js for the shared
 * namespace contract.
 */
